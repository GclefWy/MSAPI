...
namespace MagicScreenAPI
{
    public class SimpleDataHelper
    {
        ...
        /// 连接字符串模板
        /// </summary>
        internal static string connectionStringMS = ConfigurationManager.ConnectionStrings["MS"].ConnectionString;
        ...
        /// </summary>
        /// 
        public static readonly string MSConnectionString = string.Format(connectionStringMS, "MagicScreen");
